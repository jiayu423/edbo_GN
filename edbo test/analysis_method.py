...
def peak_properties(blank_data: list, reaction_data: list, internal_standard_retention_time: float = 1.81,
                    peak_width: float = 0.04, detection_limit: float = 20, plot: bool = False, save_plot=False,
...
def evaluate_performance(parent_folder: str, keyword: str, range_of_interest, wavelength_nm: int = 310):
    results = []
